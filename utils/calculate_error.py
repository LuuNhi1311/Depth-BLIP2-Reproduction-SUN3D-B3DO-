...
def compute_errors_KITTI(gt_sparse, pred, crop=True, cap=80.0):
    ...
    for current_gt_sparse, current_pred in zip(gt_sparse, pred):
        ...
        pred_uncropped[23:375, 13:1229] = current_pred
        pred = pred_uncropped
        ...
        valid_pred = pred[valid].clamp(1e-3, cap)
    ...
    return [metric.item() / batch_size for metric in [abs_diff, sq_rel, a1, a2, a3, abs_rel, rmse_tot, rmse_log_tot]]
